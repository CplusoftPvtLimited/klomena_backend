...
const Message = (props: any) => {
  ...
  return (
    <div
      className={`group w-full text-[#13343B] dark:text-[#13343B] border-b border-[#D3D3D3] dark:border-[#D3D3D3] ${
        isUser ? "dark:bg-[#FCFCF9]" : "bg-gray-50 dark:bg-[#FCFCF9]"
      }`}
    >
          ...
          <div className="w-8 flex flex-col relative items-end">
            <div className="relative h-7 w-7 p-1 rounded-sm text-white flex items-center justify-center bg-black/75 text-opacity-100r">
              {isUser ? (
                ...
                <SiKaios className="h-4 w-4 text-white" />
              )}
            </div>
